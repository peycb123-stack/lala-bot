...
def handle_image_message(event):
    try:
        ...
        route_prompt = """
คุณคือผู้เชี่ยวชาญคำนวณเส้นทางสำหรับคนขับรถส่งของในกรุงเทพฯ และปริมณฑล
...
4. ระบุ "เขตยืดระยะ": ต้องเป็นเขตหรืออำเภอที่อยู่ในแนวแกนถนนเส้นเดิม ยืดตรงต่อไปข้างหน้าไม่เกิน 20-30 กิโลเมตร เพื่อรับงานยาวต่อเนื่องได้คุ้มค่า
